...
app.get("/AppVisibility", authenticate, MasterData.getAppVisibility);
app.get("/mini/Currency", authenticate, MasterData.getCurrency);
app.get("/Currency", authenticate, MasterData.getCurrency);
app.get("/BaseLocation", authenticate, MasterData.getBaseLocation);
app.post("/BaseLocation", authenticate, MasterData.postBaseLocation);
app.get("/AssetType", authenticate, MasterData.getAssetType);
...
app.get("/CompanyInvoiceSAC", authenticate, MasterData.getCompanyInvoiceSAC);
...
app.post("/Country", authenticate, MasterData.postCountry);
app.post("/State", authenticate, MasterData.postState);
app.post("/City", authenticate, MasterData.postCity);
app.put("/Country", authenticate, MasterData.putCountry);
app.put("/State", authenticate, MasterData.putState);
app.put("/City", authenticate, MasterData.putCity);
app.delete("/Country", authenticate, MasterData.deleteCountry);
app.delete("/State", authenticate, MasterData.deleteState);
app.delete("/City", authenticate, MasterData.deleteCity);
app.get("/Department", authenticate, MasterData.getDepartment);
app.get("/Designation", authenticate, MasterData.getDesignation);
app.get("/ExpenseItemType", authenticate, MasterData.getExpenseItemType);
app.get("/LeaveType", authenticate, MasterData.getLeaveType);
app.get("/PaymentTerms", authenticate, MasterData.getPaymentTerms);
app.get("/StandardDeduction", authenticate, MasterData.getStandardDeduction);
app.get("/TaskType", authenticate, MasterData.getTaskType);
app.get("/PDFCondition", authenticate, MasterData.getPDFCondition);
app.get("/ListOfHolidays", authenticate, MasterData.getListOfHolidays);
app.post("/ListOfHolidays", authenticate, MasterData.postListOfHolidays);
app.put("/ListOfHolidays", authenticate, MasterData.putListOfHolidays);
app.delete("/ListOfHolidays", authenticate, MasterData.deleteListOfHolidays);
app.post("/AllComments", authenticate, MasterData.postAllComments);
app.get("/AllComments", authenticate, MasterData.getAllComments);
app.get("/AppVisibility", authenticate, MasterData.getAppVisibility);
app.get("/TaxCalculation", authenticate, MasterData.getTaxCalculation);
app.post("/TaxCalculation", authenticate, MasterData.postTaxCalculation);
app.put("/TaxCalculation", authenticate, MasterData.putTaxCalculation);
app.delete("/TaxCalculation", authenticate, MasterData.deleteTaxCalculation);
app.get("/EmployeeContract", authenticate, MasterData.employeeANDcontract);
